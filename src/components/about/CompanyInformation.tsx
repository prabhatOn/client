  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-yellow-500">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 xl:gap-32 relative">
            ...
            <div className="space-y-0">
              {companyInfo.slice(0, 3).map((info, index) => (
                <motion.div
                  ...
                  className="border-b border-white border-opacity-20 py-4 sm:py-6 hover:bg-white hover:bg-opacity-10 transition-colors duration-200 rounded-lg px-2 sm:px-4"
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3 sm:space-x-4">
                      <info.icon className="w-4 h-4 sm:w-5 sm:h-5 text-white flex-shrink-0" />
                      <h4 className="text-sm sm:text-base lg:text-lg font-normal text-white">
                        {info.label}
                      </h4>
                    </div>
                    <div className="text-sm sm:text-base lg:text-lg font-light text-white text-right">
                      {info.value}
                    </div>
                  </div>
                </motion.div>
